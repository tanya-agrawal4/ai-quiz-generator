    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <label className="space-y-2">
          ...
          <input
            ...
            className="w-full rounded-xl border border-border bg-surface px-4 py-3 text-sm outline-none ring-accent/20 focus:ring-4"
          />
        </label>
        <label className="space-y-2">
        ...
        <div className="p-6">
          {creatorDraft.activeTab === 'raw' && (
            <textarea
              ...
              className="w-full rounded-xl border border-border bg-muted px-4 py-3 font-mono text-sm outline-none ring-accent/20 focus:ring-4"
            />
          )}
      ...
      <div className="flex justify-end">
        <button
          ...
          className="inline-flex items-center gap-2 rounded-xl bg-accent px-5 py-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-600"
        >
